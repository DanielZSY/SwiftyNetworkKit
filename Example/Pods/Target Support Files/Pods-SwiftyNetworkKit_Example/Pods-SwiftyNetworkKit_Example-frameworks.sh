...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/BFKit-Swift/BFKit.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/SwiftyLocalKit/SwiftyLocalKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/SwiftyNetworkKit/SwiftyNetworkKit.framework"
fi
